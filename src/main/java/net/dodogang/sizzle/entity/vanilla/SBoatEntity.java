package net.dodogang.sizzle.entity.vanilla;
...
public class SBoatEntity extends BoatEntity {
	private SBoat boat;

	public SBoatEntity(EntityType<? extends SBoatEntity> type, World world, SBoat boat) {
		super(type, world);
	...
	public Packet<?> createSpawnPacket() {
		...
		return ServerSidePacketRegistry.INSTANCE.toPacket(new Identifier(Sizzle.MOD_ID, "spawn_boat"), buf);
	}

	@Override
	public void setBoatType(BoatEntity.Type type) {
		throw new UnsupportedOperationException("Tried to set the boat type of a " + Sizzle.MOD_NAME + " boat");
	}
