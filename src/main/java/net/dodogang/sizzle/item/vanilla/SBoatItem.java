package net.dodogang.sizzle.item.vanilla;
...
public class SBoatItem extends Item {
    private static final Predicate<Entity> RIDERS = EntityPredicates.EXCEPT_SPECTATOR.and(Entity::collides);
    private final Supplier<EntityType<SBoatEntity>> boatSupplier;

    public SBoatItem(Supplier<EntityType<SBoatEntity>> boatSupplier, Item.Settings settings) {
        super(settings);
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (hitResult.getType() == HitResult.Type.MISS) {
            ...
            if (hitResult.getType() == HitResult.Type.BLOCK) {
                SBoatEntity boatEntity = createBoat(world, hitResult.getPos().getX(), hitResult.getPos().getY(),
	...
	private SBoatEntity createBoat(World world, double x, double y, double z) {
		SBoatEntity entity = boatSupplier.get().create(world);
		if (entity != null) {
			entity.setPos(x, y, z);
